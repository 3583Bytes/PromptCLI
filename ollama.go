...
// waitForStreamCmd creates a Tea command that waits for the next
// message on the provided stream channel. Once a message is
// received it is returned as a tea.Msg.
